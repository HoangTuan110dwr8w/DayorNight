 ...
 */
public class ExecutorsMgr {
    private static final String TAG = "ExecutorsMgr";
    /**
     * 磁盘IO线程池
     **/
    ...
    private volatile static ExecutorsMgr ExecutorsMgr;

    public static ExecutorsMgr getInstance() {
        if (ExecutorsMgr == null) {
            synchronized (ExecutorsMgr.class) {
                if (ExecutorsMgr == null) {
                    ExecutorsMgr = new ExecutorsMgr();
                }
            }
        }
        return ExecutorsMgr;
    ...
    public ExecutorsMgr(ExecutorService diskIO, ExecutorService networkIO, Executor mainThread, ScheduledExecutorService scheduledExecutor) {
        this.diskIO = diskIO;
